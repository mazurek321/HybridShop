...
public interface IOrderRepository
{
    ...
    Task<List<Models.Order.Order>> GetByBuyerIdAsync(Guid buyerId, CancellationToken cancellationToken = default);
    Task<List<Models.Order.Order>> GetBySellerIdAsync(Guid sellerId, CancellationToken cancellationToken = default);
